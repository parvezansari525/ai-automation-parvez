...
# Load CSV
df = df = pd.read_csv('C:/Users/Parvej/Desktop/ai-automation-parvez/data/swift_messages.csv')
...
# Save output
with open('C:/Users/Parvej/Desktop/ai-automation-parvez/data/processed_swift.json', 'w') as f:
